...
<body>
	<div class="container">
		...
		<ul>
        <!-- ${orderInfo.title}은 List이기 때문에 ${orderInfo.title[0]} 형태로 사용 -->
        <li>첫 번째 책 제목: ${orderInfo.title[0]}</li>
        <li>두 번째 책 제목: ${orderInfo.title[1]}</li>
        <li>두 번째 책 제목: ${orderInfo.title[2]}</li>
    </ul>
			<!-- 배송지 정보 섹션 -->
			<div class="section">
			...
			<div class="section">
				...
				<div class="order-info">
					...
					<div class="order-info-details">
						<span>[국내도서]해외 여행의 법칙 공통수학 1 (2025)</span> <span>1개</span> <span>7/7(토)
							도착 예정</span>
					</div>
		...
		<div class="right-section">
			...
			<div class="summary-details">
				<p>
					상품 금액 <span>16,000원</span>
				</p>
				<p>
					상품 할인 <span>-1,600원</span>
				</p>
				<p>
					포인트 사용 <span>-340원</span>
				</p>
				<hr>
				<p class="total-price">
					최종 결제 금액 <span>14,060원</span>
				</p>
				<p>
					적립 예정 포인트 <span>800P</span>
				</p>
			</div>
