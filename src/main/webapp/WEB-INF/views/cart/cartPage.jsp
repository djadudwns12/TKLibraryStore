        ...
        <table class="table table-hover">
            ...
            <tbody>
                <c:forEach var="cart" items="${cartList}">
                    <tr>
                        <td class="common-td"><input type="checkbox" class="selectItem" onclick="updateTotals()" data-price="${cart.price}" data-salePrice="${cart.salePrice}" data-qty="${cart.qty}"></td>
                        <td class="thumbnail"><img src="${cart.thumbNail}" style="width: 70px;" /></td>
                        <td class="common-td">${cart.title}</td>
                        <td class="common-td">
                            <div>
                                <fmt:formatNumber value="${cart.price}" type="number" groupingUsed="true" />
                                원
                            </div>
                        </td>
                        <td class="common-td">
                            <div>
                                <fmt:formatNumber value="${cart.salePrice}" type="number" groupingUsed="true" />
                                원
                            </div>
                        </td>
                        <td class="common-td">
                        ...
                        <td class="common-td"><img src="/resources/images/cart_delete.png" width=30px; onclick="showDeleteModal('${cart.cartId}', this);"></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger modalCloseBtn" onclick="$('#myModal').modal('hide');">취소</button>
                </div>
            </div>
        </div>
    </div>
