		...
		<form class="form-container">
			...
			<div class="form-group">
				<input type="text" id="receiver_phone" name="receiver_phone"
					value="${address.receiver_phone}" required>
			</div>

			<div class="form-group button-container" name="addrForm"
				id="addrForm">
				<input type="text" id="keyword" name="keyword"
					placeholder="${address.address.split(',')[0]}" required>
			...
			<div class="form-group">
				<input type="text" id="addressDetail" name="addressDetail"
					placeholder="${address.address.split(',')[1] != null ? address.address.split(',')[1].trim() : ''}"
					required>
			</div>
			...
			<div class="button-container" style="display: flex;">
				...
				<button type="button" onclick="location.href='/member/address'">취소</button>
			</div>
		</form>
